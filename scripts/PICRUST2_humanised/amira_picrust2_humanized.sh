...
rm -rf ${path_to_home}Metwaly-et-al.-2020/Data/PICRUSt2_humanised/picrust2_res/picrust2_out_pipeline_edited/KO_metagenome_out/pred_metagenome_unstrat.tsv.gz
